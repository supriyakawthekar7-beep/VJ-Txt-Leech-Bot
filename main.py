...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8624116563:AAE1_KuO8478eqMSpEpRLgZrMdWFxaHfeBs")
    API_ID = int(os.environ.get("API_ID",  "27849461"))
    API_HASH = os.environ.get("API_HASH", "8d828c37ffdd9872e0756571cb6bc183")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '6673889571').split(',')
